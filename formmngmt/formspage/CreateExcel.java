...
public class CreateExcel {
	...
	public CreateExcel(String[] arrayofheader, List<Map<String, Object>> excelfinaldata) {
	...
	private void writeDataLines() {
		...
		for (Map<String, Object> hashmap_data : excelfinaldata) {
			...
			for (String headercontent : arrayofheader) {
				if (headercontent.equalsIgnoreCase("Date")) {
					String[] array = hashmap_data.get(headercontent).toString().split(" ");
					createCell(rows, columnCount++, array[0], style);
				} else {
